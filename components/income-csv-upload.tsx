...
import { IncomeFormatModal } from "@/components/income-format-modal"
import { uploadIncome } from "@/src/app/actions/upload-income"
import { Alert, AlertDescription, AlertTitle } from "@/components/ui/alert"
import { Collapsible, CollapsibleContent, CollapsibleTrigger } from "@/components/ui/collapsible"

interface IncomeCSVUploadProps {
  month: string
  year: number
  onSuccess: () => void
}
...
export function IncomeCSVUpload({ month, year, onSuccess }: IncomeCSVUploadProps) {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      if (result.success) {
        ...
        toast.error("Error uploading income", {
  ...
  return (
    <>
      <Card>
        ...
        <CardContent>
          <div className="flex justify-between items-center mb-4">
            <p className="text-muted-foreground">Upload your income CSV file</p>
            <Button
              variant="ghost"
              size="sm"
          ...
          {error && (
            <Alert variant="destructive" className="mb-4">
              ...
              <AlertTitle>Error uploading income</AlertTitle>
              <AlertDescription>
                {error}
                {debugInfo && (
          ...
          {uploadResult && (
            <Alert className="mb-4">
              ...
              <AlertDescription>
                <p>Successfully imported {uploadResult.count} income entries.</p>
                    ...
                    <CollapsibleContent className="mt-2">
                      <div className="text-sm border rounded-md p-3 bg-muted/50">
                        ...
                        <p className="mt-3 text-xs">
                          Common issues include missing required fields (income type, amount), invalid amounts, or
          ...
          >
            {selectedFile ? (
              ...
              <>
                ...
                <p className="text-muted-foreground mb-4">Drag and drop your income CSV file, or click to browse</p>
                <p className="text-xs text-muted-foreground mb-4">
                  Expected format: Income Type, Income Amount
                </p>
      ...
      <IncomeFormatModal open={formatModalOpen} onClose={() => setFormatModalOpen(false)} />
    </>
  )
}
